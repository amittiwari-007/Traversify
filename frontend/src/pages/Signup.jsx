import { Form, json, useActionData, useNavigation ,Navigate} from 'react-router-dom';
    ...
    <main className="main">
      ...
      <div className="login-form">
        ...
        <Form method="post" className="form form--login">
          ...
          {user && !user.status && <Navigate to='/'></Navigate> }
...
export async function action({ request }) {
  ...
  const configuration = {
    method: 'post',
    url: `${import.meta.env.VITE_API_URL}api/v1/users/signup/`,
    data: authData,
  ...
  try {
    ...
    throw json({ message: error.data.message }, { status: error.data.status });
  }
}
